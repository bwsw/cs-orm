...
* under the License.
*/
package com.bwsw.cloudstack.entities.responses.serviceoffering

import com.bwsw.cloudstack.entities.responses.common.{EntityFindResponse, EntityList}
import com.fasterxml.jackson.annotation.JsonProperty

case class ServiceOfferingFindResponse(@JsonProperty("listserviceofferingsresponse") override val entityList: ServiceOfferingList)
