...
* under the License.
*/
package com.bwsw.cloudstack.entities.responses.user

import com.bwsw.cloudstack.entities.responses.common.{EntityFindResponse, EntityList}
import com.fasterxml.jackson.annotation.JsonProperty

case class UserFindResponse(@JsonProperty("listusersresponse") override val entityList: UserList) extends EntityFindResponse(entityList)
