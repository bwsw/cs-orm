...
* under the License.
*/
package com.bwsw.cloudstack.entities.responses.zone

import com.bwsw.cloudstack.entities.responses.common.{EntityFindResponse, EntityList}
import com.fasterxml.jackson.annotation.JsonProperty

case class ZoneFindResponse(@JsonProperty("listzonesresponse") override val entityList: ZoneList) extends EntityFindResponse(entityList)
