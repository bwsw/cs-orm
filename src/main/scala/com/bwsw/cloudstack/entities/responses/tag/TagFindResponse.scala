...
* under the License.
*/
package com.bwsw.cloudstack.entities.responses.tag

import com.bwsw.cloudstack.entities.responses.common.{EntityFindResponse, EntityList}
import com.fasterxml.jackson.annotation.JsonProperty

case class TagFindResponse(@JsonProperty("listtagsresponse") override val entityList: TagSet) extends EntityFindResponse(entityList)
