...
* under the License.
*/
package com.bwsw.cloudstack.entities.responses.template

import com.bwsw.cloudstack.entities.responses.common.{EntityFindResponse, EntityList}
import com.fasterxml.jackson.annotation.JsonProperty

case class TemplateFindResponse(@JsonProperty("listtemplatesresponse") override val entityList: TemplateList) extends EntityFindResponse(entityList)
